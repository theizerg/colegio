...
class JornadaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$this->esUnica($jornada)) {
            flash('
                <h4>Error en Ingreso de Datos</h4>
                <p>Ya existe un registro de la jornada laboral de <strong>' . $jornada->docente->nombre . ' ' . $jornada->docente->apellido . '</strong> en esa fecha.</p>
            ')->error()->important();
        ...
        flash('
            ...
            <p>La jornada laboral del docente <strong>' . $jornada->docente->nombre . ' ' . $jornada->docente->apellido . '</strong> se ha registrado correctamente.</p>
        ')->success()->important();
