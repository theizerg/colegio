...
<div class="box box-primary">
  ...
  <!-- Formulario -->
  {!! Form::open(['route' => 'horario.store', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
    <div class="box-body">
     ...
     <!-- Anio -->
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <input type="text" name="Lunes" placeholder="Ingrese la hora" class="form-control">
          @if ($errors->has('docente_id'))
          <span class="help-block">{{ $errors->first('docente_id') }}</span>
          @endif
        </div>
      ...
      <div class="form-group{{ $errors->has('docente_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          <input type="text" name="Martes" placeholder="Ingrese la hora" class="form-control">
          @if ($errors->has('docente_id'))
          <span class="help-block">{{ $errors->first('docente_id') }}</span>
          @endif
        </div>
       ...
       <div class="form-group{{ $errors->has('docente_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          <input type="text" name="Miercoles" placeholder="Ingrese la hora" class="form-control">
          @if ($errors->has('docente_id'))
          <span class="help-block">{{ $errors->first('docente_id') }}</span>
          @endif
        </div>
       ...
       <div class="form-group{{ $errors->has('docente_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          <input type="text" name="Jueves" placeholder="Ingrese la hora" class="form-control">
          @if ($errors->has('docente_id'))
          <span class="help-block">{{ $errors->first('docente_id') }}</span>
          @endif
        </div>
       ...
       <div class="form-group{{ $errors->has('docente_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          <input type="text" name="Viernes" placeholder="Ingrese la hora" class="form-control">
          @if ($errors->has('docente_id'))
          <span class="help-block">{{ $errors->first('docente_id') }}</span>
          @endif
        </div>
      ...
      <div class="form-group{{ $errors->has('alumno_id') ? ' has-error' : '' }}">
        {!! Form::label('user_id>', 'Selecciona el usuario del alumno', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-6">
