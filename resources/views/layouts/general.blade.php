...
<div class="wrapper">
  ...
  <header class="main-header ">
    <!-- Logo -->
    <a href="#" class="logo red darken-4">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">
        <img src="{{ asset('img/sistema/logo_blanco.png') }}" class="logo-mini-tamanio" alt="Mini logo" />
      </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Presidente Kennedy</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top red darken-4">
      ...
      <div class="navbar-custom-menu red darken-4">
      ...
      <ul class="sidebar-menu " data-widget="tree">
        ...
        <li>
		 ...
		 <li class="treeview active">
          <a href="#">
            <i class="fa fa-shield"></i> <span>Horarios</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="display: block;">
            <li class=""><a href="{{ route('horario.index') }} "><i class="fa fa-circle-o"></i>Horario del alumno</a></li>
        ...
        <li>
         ...
         <li>
          <a href="{{ route('jornadas.index') }}">
            <i class="fa fa-users"></i> <span>Horario del docente</span>
          </a>
        </li>        
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="display: block;">
            <li class=""><a href="{{ route('users.index') }} "><i class="fa fa-circle-o"></i> Usuarios</a></li>
            <li><a href="{{ route('roles.index') }}"><i class="fa fa-circle-o"></i> Roles de usuario</a></li>
          </ul>
        </li>
        @elseif(\Auth::user()->docen())
         <li>
          <a href="{{ route('alumnos.index') }}">
            <i class="fa fa-child"></i> <span>Alumnos</span>
          </a>
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-shield"></i> <span>Notas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="display: block;">
            <li class=""><a href="{{ route('notas.index') }} "><i class="fa fa-circle-o"></i> Notas generales</a></li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu" style="display: block;">
            <li class=""><a href="{{ route('horario.index') }} "><i class="fa fa-circle-o"></i> Horario del estudiante</a></li>
  ...
  <footer class="main-footer no-print">
    ...
    <strong>Copyright &copy; 2021 <a href="#">Centro Escolar Fe y Alegria</a></strong>
  </footer>
</div>
<!-- ./wrapper -->
